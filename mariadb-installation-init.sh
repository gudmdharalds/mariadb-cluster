...
echo "GRANT ALL PRIVILEGES ON *.* TO root@'172.17.%' IDENTIFIED BY '$PASS' WITH GRANT OPTION" | mysql -u root -p$PASS  
echo "GRANT ALL PRIVILEGES ON *.* TO root@'.' IDENTIFIED BY '$PASS' WITH GRANT OPTION" | mysql -u root -p$PASS 
